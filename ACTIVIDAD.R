...
#el método rep repite la acción de poner la media total en cada una de las lineas del dataset
media_dataset$media_total <- rep(media_total, nrow(media_dataset))
